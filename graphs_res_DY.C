...
void graphs_res_DY(TString inDir = "mets", TString sDir = "met_plots", TString sName = "DY")
{
...
cout << "Reading texts in ./"+inDir+tNum+"..." << endl;
	...
	fmu1.open("./"+inDir+tNum+"/GenMu1.txt");
	fmu2.open("./"+inDir+tNum+"/GenMu2.txt");
...
//cout << "Para puppi pu200 event: "<< hParaPu[i]->GetEntries() <<", resol: "<< aPuParaSol[i] << endl;
...
//	f1->Close();
   ...
   TText *label = new TText(165.7277,1.856606,"DY PU200");
	...
	gHGen->GetYaxis()->SetTitleOffset(1.1);
	gHGen->Draw("APL");
	gHPF->Draw("PLSAME");
	gHPu->Draw("PLSAME");
	label->Draw();
   ...
   TLegend *lg3 = new TLegend(0.1833274,0.6787755,0.566315,0.8404082,NULL,"brNDC");
   TText *label2 = new TText(19.92138,187.2718,"DY PU200");
   ...
   TLegend *lg_per = new TLegend(0.1803469,0.6330612,0.7227885,0.8420408,NULL,"brNDC");
